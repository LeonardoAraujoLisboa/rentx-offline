...
const Profile = () => {
    ...
    const handleSignOut = async () => {
        Alert.alert(
            ...
            ]//no Alert voce pode colocar botões (isso ai são botões)
        )
    }
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <Container>
                    ...
                    <Content style={{marginBottom: useBottomTabBarHeight()}}>
                        ...
                        option === 'dataEdit' ? 
                        <Section>
                            <Input iconName='user' placeholder='Nome' autoCorrect={false} defaultValue={user.name} onChangeText={setName} />
                            <Input iconName='mail' editable={false} defaultValue={user.email} />
                            <Input iconName='credit-card' placeholder='CNH' keyboardType='numeric' defaultValue={user.driver_license} onChangeText={setDriverLicense} />
                        </Section> : 
                        <Section>
